...
edit_address = (By.ID, "ya-myab-address-edit-btn-0")
edit_apt_no = (By.ID, "address-ui-widgets-enterAddressLine2")
...
filter_by_brands = (By.XPATH, "//span[text()='Chuckit!']")
...
selected_product1 = (By.XPATH, "//span[contains(text(),'Chuckit! Ultra Ball Dog Toy')]")
...
selected_product2 = (By.XPATH, "(//span[contains(text(),'Strips With Real Meat Dog')])[1]")
