...
child_age_dd = (By.XPATH, "//select[@data-ui-name='select_occupancy_children_age_0']")
...
#dob1_date = (By.XPATH, "(//input[@name='passengers.0.birthDate'])[2]")
#dob1_month = (By.XPATH, "//select[@autocomplete='bday-month']")
#dob1_year = (By.XPATH, "//input[@data-testid='traveller_data_field_passenger_0_yyyy']")
...
child_details = (By.XPATH, "//span[contains(text(),'traveler’s details')]")
child_fn = (By.XPATH, "//input[@name='passengers.2.firstName']")
child_ln = (By.XPATH, "//input[@name = 'passengers.2.lastName']")
child_gender = (By.XPATH, "//select[@name='passengers.2.gender']")
dob_date = (By.XPATH, "(//input[@name='passengers.2.birthDate'])[2]")
dob_month = (By.XPATH, "//select[@name='passengers.2.birthDate']")
dob_year = (By.XPATH, "(//input[@name='passengers.2.birthDate'])[3]")
done_button3 = (By.XPATH, "//button[@data-testid='grouped_inputs_traveller_done_3']")

contact_details = (By.XPATH, "//input[@name='booker.email']")
#country_code_dd = (By.XPATH, "//select[text()='India (+91)']")
